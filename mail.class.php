...
class mia_mail {
    ...
    $this->altsep="my-alt-".$this->sep;
		...
		$this->fineriga="\r\n";
		$this->smtp_server="mail.example.com";
		$this->smtp_port="25";
    $this->smtp_user="no_reply@example.com";
    $this->smtp_pass="mypass";
		$this->smtp_timeout="30";
		$this->FromName="Your Name";
		$this->From="no_reply@example.com";
		$this->ReplyTo="reply@example.com";
		$this->ReplyToName="Your Name";
		$this->ReturnPath="no_reply@example.com";
		$this->immaginefirma="../path/to/imagesignature.png";
		$this->testofirma="<br />Your Text for signature";
	...
	* @return string 
	...
	/*
	 * Get the file representing the email
	 */
